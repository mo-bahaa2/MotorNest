...
export default function Register() {
  ...
  const validationSchema = yup.object({
    ...
    password: yup.string()
      ...
      .matches(
        /^[A-Z](?=.*\d)(?=.*[^A-Za-z0-9]).{4,9}$/,
        'Password must start with capital, include a number and a symbol, and be 5-10 characters'
      ),
  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 py-10 relative overflow-hidden bg-[#F5F5F5] mt-9">
      ...
      {/* Form Container */}
      <div className="w-full max-w-2xl bg-white/95 backdrop-blur-sm rounded-xl p-8 shadow-lg border border-[#EEEEEE] relative z-10 animate-fade-up duration-700">
        {/* Header with Golden Accent */}
        <div className="mb-8 text-center relative">
          <div className="w-16 h-1 bg-[#FFD700] mx-auto mb-4 rounded-full"></div>
          <h2 className="text-3xl font-bold text-[#333333]">Create Your Account</h2>
          <p className="text-[#9E9E9E] mt-2">Fill in the details to get started</p>
